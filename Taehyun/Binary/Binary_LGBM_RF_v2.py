...
def perform_forward_selection(all_data, all_feats, target_col):
    ...
    print("\n[단계 1] SHAP을 통해 전체 피처의 중요도 순위를 계산합니다 (SMOTE 적용)...")
        ...
        for params in param_list:
            ...
            for train_idx, valid_idx in cv_splitter.split(X_all, y_all):
                ...
                if model_name == "LightGBM":
                    ...
                    model.fit(X_tr_res, y_tr_res, eval_set=[(X_va, y_va)], eval_metric='auc', callbacks=[lgb.early_stopping(50, verbose=False)])
...
plt.tight_layout()
plt.savefig(r"C:\Users\윤태현\.gemini\antigravity-ide\brain\d881410c-9019-4a0b-b882-dc261a2c2238\eda_plots\forward_selection_v2.png", dpi=150)
plt.show() 
#plt.close()
...
plt.tight_layout()
plt.savefig(r"C:\Users\윤태현\.gemini\antigravity-ide\brain\d881410c-9019-4a0b-b882-dc261a2c2238\eda_plots\confusion_matrix_v2.png", dpi=150)
plt.show() 
#plt.close()
