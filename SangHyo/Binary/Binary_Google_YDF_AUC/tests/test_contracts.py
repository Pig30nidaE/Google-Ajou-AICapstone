...
from SangHyo.Binary.Binary_Google_YDF_AUC import data, features, models
from SangHyo.Binary.Binary_Google_YDF_AUC import selection
...
def test_notebook_arguments_and_extended_cli_contract() -> None:
    from SangHyo.Binary.Binary_Google_YDF_AUC import run
