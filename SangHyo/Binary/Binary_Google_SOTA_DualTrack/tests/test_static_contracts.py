...
from SangHyo.Binary.Binary_Google_SOTA_DualTrack import data, features, metrics

sys.path.insert(0, str(Path(__file__).resolve().parents[2]))

from SangHyo.Binary.Binary_Google_SOTA_DualTrack import preprocessing  # noqa: E402
from SangHyo.Binary.Binary_Google_SOTA_DualTrack.data import LeakageGuardError  # noqa: E402
...
def test_parse_args_survives_jupyter_kernel_argv():
    ...
    from SangHyo.Binary.Binary_Google_SOTA_DualTrack import run as runner
...
def test_soft_voting_weights_match_the_report():
    from SangHyo.Binary.Binary_Google_SOTA_DualTrack.models import SOFT_VOTING_WEIGHTS
