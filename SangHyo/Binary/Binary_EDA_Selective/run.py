...
def run_pipeline(*, namespace=None, data_root=None, output_dir=None, mode=None,
    ...
    _write_status(output, {"status": "starting", "experiment": EXPERIMENT_NAME,
                           ...
                           "output_dir": str(output), "compute_note": "CPU-only interpretable model on EDA-selected features."})

    from SangHyo.Binary.Binary_EDA_Selective.train import RunConfig, run_experiment
