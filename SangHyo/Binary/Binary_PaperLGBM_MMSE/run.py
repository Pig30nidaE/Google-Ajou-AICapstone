"""base.ipynb entry point — leakage-free LightGBM paper reproduction (with MMSE).
...
EXPERIMENT_NAME = "Binary_PaperLGBM_MMSE"
INCLUDE_MMSE = True
...
def run_pipeline(*, namespace=None, data_root=None, output_dir=None, mode=None,
    ...
    from SangHyo.Binary.Binary_PaperLGBM_MMSE.paperlib import RunConfig, run_experiment
