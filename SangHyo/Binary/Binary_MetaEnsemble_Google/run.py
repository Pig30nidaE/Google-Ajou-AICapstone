...
def run_pipeline(*, namespace=None, data_root=None, output_dir=None, mode=None,
    ...
    _write_status(output, {"status": "starting", "experiment": EXPERIMENT_NAME,
                           ...
                           "output_dir": str(output), "compute_note": "Meta-ensemble of M1+M2(YDF)+M3; CPU-friendly."})

    from SangHyo.Binary.Binary_MetaEnsemble_Google.train import RunConfig, run_experiment
