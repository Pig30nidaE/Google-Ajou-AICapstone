...
if __package__:  # Collision-safe package import when launched from base.ipynb.
    ...
    from SangHyo.Binary.Binary_Wearable_GoogleModels.data import build_binary_dataset  # type: ignore
    from SangHyo.Binary.Binary_Wearable_GoogleModels.eda import run_eda  # type: ignore
    from SangHyo.Binary.Binary_Wearable_GoogleModels.models import (  # type: ignore
        CLASS_NAMES,
        GOOGLE_MODEL_EVIDENCE,
        MODEL_NAMES,
        fit_model,
    ...
    from SangHyo.Binary.Binary_Wearable_GoogleModels.preprocessing import FoldPreprocessor, assert_feature_contract  # type: ignore
